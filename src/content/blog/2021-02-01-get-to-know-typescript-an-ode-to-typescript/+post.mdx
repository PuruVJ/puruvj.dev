...
![Weird input sum values](./code-sample-1.gif)
...
![Weird input sum values error](./code-sample-2.gif)
...
![Template literal types demo](./template-literal-type.gif)
...
Proof it works: ![Intersection types work](./intersection-type.gif)
...
![Pick type helper demo](./code-sample-pick-helper-type.gif)
...
![Styled Components usage of Pick](./pick-styled-components.png)
