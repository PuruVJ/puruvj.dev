...
## Some controversal things

Some things are changing which could be seen as negatives, but in long term I think are absolutely needed and worth it.
...
Hence both of these are going. However, the transform function is not, and can be used like this:
