...
![Can this 5 minute task be automated?](../2020-09-25-gif-to-mp4-ffmpeg-fluent-web/dev-automation-10-min.jpg)
...
![Hold up a minute meme](./hold-up.jpg)
...
![Perfection meme from X Men](../2021-04-16-move-to-css-modules-from-styled-components/perfection.gif)
...
![Comparison of the binary size and memory consumption generated by Deno and Go](./go-vs-deno-size-comparison.png)
