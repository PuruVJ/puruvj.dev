...
cover_image: ./promises-everywhere.jpg
---
...
![Goku pushing callbacks](./goku-meme.gif)
...
Check out my article to know this uncanny art: [Simple code with fs.promises and async await](../blog/fs-promises).
