...
![Demo of CSS Modules autocompletion](./intellisense-demo.gif)
...
> And yeah, in case you were wondering, TypeScript does have its own plugin architecture. Heck, I myself found it only a month back, [when I moved a project of mine to CSS Modules from Styled Components](../blog/move-to-css-modules-from-styled-components) 😅.
