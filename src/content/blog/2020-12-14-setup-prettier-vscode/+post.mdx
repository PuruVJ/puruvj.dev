...
![Tony and Cap Shake hand](./tony-cap-handshake-endgame.gif)
...
![Tony punch Cap in his perfect teeth](./tony-punch-cap-perfect-teeth.gif)
...
![VSCode right click to format](./format-option-vscode.gif)
...
![Format on Save](./format-on-save.gif)
