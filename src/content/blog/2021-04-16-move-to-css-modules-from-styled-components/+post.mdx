...
![Hail modularity](./hail-modularity.jpg)
...
![Here be dragons](./here-be-dragons.gif)
...
![Why? Why shouldn't I not use CSS Modules](./bilbo-keep-it-meme.jpg)
...
![Unmodified Styled Components](./unmin-styled-comps-code.png)
...
![Optimized CSS Module file](./optimised-css-modules.png)

And here's the `index.js` 👇

![Optimised JavaScript](./optimised-js.png)
...
![Gamora: What did it cost?; Thanos: Everything](./thanos-gamora-everything.gif)
...
const Container = styled.section<ContainerProps>`
  ...
  ${({ columnStart, columnSpan, rowSpan, rowStart, theme: localTheme }) => css`
    ...
    box-shadow: hsla(0, 0%, 0%, 0.3) 0px 1px 4px -1px, 0 0 0 ${localTheme ===
        'dark'
          ? 0.4
          : 0}px hsla(${theme.colors.dark.hsl}, 0.3);
  `};
`;
```
