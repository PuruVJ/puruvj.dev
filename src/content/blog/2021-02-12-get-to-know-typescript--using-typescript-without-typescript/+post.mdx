...
![Hermione losing her mind](./hermione-goes-crazy.gif)
...
![Double terminals](./double-terminals.png)
...
![JSDoc demo function square](./jsdoc-starting.gif)
...
So let's take a look at this small TypeScript program. This is the same one I used in the predecessor of this blog post, [An Ode ❤ to TypeScript](../blog/get-to-know-typescript-an-ode-to-typescript)
