...
cover_image: ./fs-promise-requires.jpg
---
...
Also, if your node version is more than <mark>v14.8.0</mark>, you can also directly use top level await (I have an article about it, [right here](../blog/top-level-await)).
