...
![Dock animation preview as GIF](./animation-preview.gif)
...
![Basic MacOS colorful wallpaper](./scaffold-wallpaper.png)
...
<style>
  ...
  .dock-el {
    ...
    box-shadow: inset 0 0 0 0.2px rgb(245 245 245 / 70%), hsla(0, 0%, 0%, 0.3) 2px
        5px 19px 7px;
...
![The Dock itself](./the-dock-itself.png)
...
![Boundaries](./marked-dock-positions.jpg)
