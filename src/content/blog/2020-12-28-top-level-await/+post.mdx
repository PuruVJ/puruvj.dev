...
cover_image: ./top-of-the-world.jpg
---

import BlogImage from '@components/BlogImage.astro';
export const components = { img: BlogImage };

<mark>Top Level Await</mark> is literally awesome. It's the GOAT!!(**G**reatest **o**f
**A**ll **T**ime, in case you couldn't guess 😉)
...
> <mark>IIFE</mark>: Immediately Invoked Function expressions. [Flavio Copes has
> a really good article about it.](https://flaviocopes.com/javascript-iife/)
...
I have written a blog post about this utility function too. [Check it out here](../blog/flatten-settimeout)
...
![Darth Vader: The force is strong with this one](./force-strong-darth-vader.gif)
