...
h(
  'div',
  { class: 'haha' },
  h('span', { key: 34 }, h('h1', {}, h('span', {}, 'Whoa'))),
);
```
...
![Astronaut at gunpoint: So its all just useMemo...? Astronaut with gun: Always has been](./always-has-been-meme.jpg)
